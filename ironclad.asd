...
#+(or)                                   (:file "blowfish" :depends-on ("cipher"))
#+(or)                                   (:file "twofish" :depends-on ("cipher"))
#+(or)                                   (:file "threefish" :depends-on ("cipher"))
                                   (:file "idea" :depends-on ("cipher"))
                                   (:file "misty1" :depends-on ("cipher"))
#+(or)                                   (:file "square" :depends-on ("cipher"))
...
#+(or)                                   (:file "serpent" :depends-on ("cipher"))
                                   ;; stream ciphers
                                   (:file "arcfour" :depends-on ("cipher"))
#+(or)                                   (:file "salsa20" :depends-on ("cipher"))
#+(or)                                   (:file "chacha" :depends-on ("cipher"))))
                         (:module "digests"
...
#+(or)                                   (:file "blake2" :depends-on ("digest"))
#+(or)                                  (:file "blake2s" :depends-on ("digest"))))
                         (:module "macs"
